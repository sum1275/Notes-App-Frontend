...
const Home = () => {
  ...
  const getAllNotes = async () => {
    try {
      const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/note/all`, {
  ...
  const deleteNote = async (data) => {
    ...
    try {
      const res = await axios.delete(
        `${import.meta.env.VITE_API_BASE_URL}/note/delete/` + noteId,
        { withCredentials: true }
      );
  ...
  const onSearchNote = async (query) => {
    try {
      const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/note/search`, {
        params: { query },
        withCredentials: true,
      });
  ...
  const updateIsPinned = async (noteData) => {
    ...
    try {
      const res = await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/note/update-note-pinned/` + noteId,
